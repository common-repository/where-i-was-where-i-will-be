...
<?php
    ...
    $map_id = (!empty($map_id))?$map_id:uniqid('_');
...
?>
<div id="map_<?php echo $map_id; ?>" <?php echo $class; ?> <?php echo $style; ?>></div>
...
<?php
    ...
    if ((strtolower($show_coord) == 'last') || !$show_coord) $coord = $local->latitude.','.$local->longitude;
...
?>    
    ...
    var map<?php echo $map_id; ?> = new google.maps.Map(document.getElementById('map_<?php echo $map_id; ?>'), {
