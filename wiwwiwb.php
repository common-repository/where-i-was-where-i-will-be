...
function wiw_scripts() {
    ...
    if (get_option('wiw_load_google_api') !== 'on') {
        wp_register_script( 'wiw_google_script','https://maps.googleapis.com/maps/api/js?key='.get_option('wiw_google_api').'&language='.get_option('WPLANG').'&libraries=places,geometry,drawing'); //Google API
